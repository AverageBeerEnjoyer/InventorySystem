...
fun main() {
    ...
    val errorMessageFilter = ShowErrorMessageFilter(htmlView)
    val authorizationFilter=AuthorizationFilter(htmlView, operationStorage.decodeTokenOperation,operationStorage.fetchWithLoginEmployeeOperation)
    val app: HttpHandler = errorMessageFilter
